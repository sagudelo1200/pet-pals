export const ERR = {
  ...
  PASEOS: {
    ...
    ESTADO_NO_ESPERADO: 'ESTADO_NO_ESPERADO',
    UBICACION_INVALIDA: 'UBICACION_INVALIDA',
    COORDENADAS_INVALIDAS: 'COORDENADAS_INVALIDAS',
    CODIGO_RECOGIDA_FORMATO_INVALIDO: 'CODIGO_RECOGIDA_FORMATO_INVALIDO',
    CODIGO_RECOGIDA_INCORRECTO: 'CODIGO_RECOGIDA_INCORRECTO',
    CODIGO_RECOGIDA_BLOQUEADO: 'CODIGO_RECOGIDA_BLOQUEADO',
    CODIGO_RECOGIDA_VALIDADO: 'CODIGO_RECOGIDA_VALIDADO',
  },

  UBICACION: {
    PERMISO_DENEGADO: 'PERMISO_UBICACION_DENEGADO',
    SERVICIOS_DESACTIVADOS: 'GPS_DESACTIVADO',
    TIMEOUT: 'TIMEOUT_UBICACION',
    ERROR_DISPOSITIVO: 'ERROR_UBICACION_DISPOSITIVO',
