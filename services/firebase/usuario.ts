...
export class UsuarioService {
  ...
  static async create(data: Omit<Usuario, 'id' | 'createdAt' | 'updatedAt' | 'createdBy' | 'updatedBy'>): Promise<CrudResult<Usuario>> {
  ...
  static async update(id: string, data: Partial<Omit<Usuario, 'id' | 'createdAt' | 'createdBy'>>): Promise<CrudResult<Usuario>> {
